...
class getInputCVE(object):
    ...
    def _is_recent_enough(self, hours):
        '''
    ...
    def fetch_dist_data(self, hours_old):
        ...
        '''
        if not self._is_recent_enough(hours_old):
            print "CVE Input is out of date or exceeds {0} hours old.".format(hours_old)
            for dist in self.dists:
